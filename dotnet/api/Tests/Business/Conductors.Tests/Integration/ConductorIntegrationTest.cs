...
namespace AndcultureCode.GB.Business.Conductors.Tests.Integration
{
        ...
        where TSut : class
    {
        ...
        private IServiceCollection ConfigureConfiguration(IServiceCollection services)
        {
            return services;
        }
        ...
        private IServiceCollection ConfigureLocalization(IServiceCollection services)
        {
            services.AddScoped<IStringLocalizer>((sp) => Mock.Of<IStringLocalizer>());
        ...
        public ConductorIntegrationTest(
        ...
        ) : base(output, fixture.Context)
        {
            ...
            // TODO: The caching here is not being properly reset and it seems to be causing side effects.
